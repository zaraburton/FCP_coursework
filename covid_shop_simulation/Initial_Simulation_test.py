...
The script can be used to:
    ...
    2. Show a plot of number of people in the shop against
    3. Show a plot of SIR level against duration
...
def GUI_run(max_entry,duration,max_shoppers,month, path_system):
    sim = simulation(max_entry, duration, max_shoppers, month, path_system)
    sim.add_new_shopper()
